...
local vehshop = {
	...
	menu = {
		...
		["Motos"] = {
			...
			name = "Motos",
			buttons = {
				{name = "Hornet", costs = 90000, description = {}, model = "vader"},
				{name = "BMW", costs = 50000, description = {}, model = "carbonrs"},
				...
				{name = "RESTE", costs = 40000, description = {}, model = "carbonrs"},
			...
			for i,button in pairs(menu.buttons) do
				if i >= vehshop.menu.from and i <= vehshop.menu.to then
					...
					if button.costs ~= nil then
						if vehshop.currentmenu == "Nacionais" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "supers" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "Motos" then
...
function vehSR_ButtonSelected(button)
	...
	elseif this == "Carros" then
		...
		elseif btn == "Nacionais" then
			vehSR_OpenMenu('Nacionais')
	...
	elseif this == "Nacionais" or this == "coupes" or this == "sedans" or this == "sports" or this == "sportsclassics" or this == "supers" or this == "muscle" or this == "offroad" or this == "suvs" or this == "vans" or this == "industrial" then
...
function vehSR_Back()
	...
	if vehshop.currentmenu == "main" then
		vehSR_CloseCreator("","")
	elseif vehshop.currentmenu == "Nacionais" or vehshop.currentmenu == "coupes" or vehshop.currentmenu == "sedans" or vehshop.currentmenu == "sports" or vehshop.currentmenu == "sportsclassics" or vehshop.currentmenu == "supers" or vehshop.currentmenu == "muscle" or vehshop.currentmenu == "offroad" or vehshop.currentmenu == "suvs" or vehshop.currentmenu == "vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "Motos" then
		if DoesEntityExist(fakecar.car) then
			Citizen.InvokeNative(0xEA386986E786A54F, Citizen.PointerValueIntInitialized(fakecar.car))
		end
		fakecar = {model = '', car = nil}
