  ...
  ["/discord"] = {
    ...
    action = function(p,color,msg) 
        TriggerClientEvent("pNotify:SetQueueMax",p,"global", 8)
                ...
                TriggerClientEvent("pNotify:SendNotification",p,{text = "<b style='color:MediumPurple'>https://discord.gg/mddYE7S</b> ", type = "info", timeout = (3000),layout = "centerLeft", sounds = {volume = 1.0,sources = {"sound-example.wav"}}})
    end
  },  
